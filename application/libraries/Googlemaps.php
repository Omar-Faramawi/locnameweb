...
class Googlemaps {
	...
	var $directionsWaypointsOptimize= FALSE;					// Should the waypoints be optimised? If TRUE, waypoints will be re-ordered to provide the most efficient route.
        var $suppressMarkers = true ;                                               // remove default marker in direcrtion  , Referance https://developers.google.com/maps/documentation/javascript/reference?csw=1#DirectionsRendererOptions
		...
		if ($this->directions) {
			...
			';
				$rendererOptions = 'rendererOptions';
                        ...
                        if($this->suppressMarkers){
                            $this->output_js_contents .= '
			if(typeof rendererOptions != "undefined" ) rendererOptions.suppressMarkers = true; else var rendererOptions = {suppressMarkers:true} ;
			';
				$rendererOptions = 'rendererOptions';
                        }
