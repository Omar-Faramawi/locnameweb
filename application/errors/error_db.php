...
<!--[if (gte IE 9)|!(IE)]><!--><html  prefix="og: http://ogp.me/ns#" lang="en"> <!--<![endif]-->
    ...
    <body class="fixed-enabled">
        ...
        <header <?php (!is_home()) ? 'id="header"' : 'class="header-map"' ?> >
            <div class="header-inside">
                <div class="header-top">
                    <section class="container clearfix">
                        <ul class="social">
                            <li><a target="_blank" href="http://facebook.com/Locname"><i class="fa fa-facebook"></i></a></li>
                            <li><a target="_blank" href="https://twitter.com/Loc_Name"><i class="fa fa-twitter"></i></a></li>
                            <!--<li><a href="#"><i class="fa fa-rss"></i></a></li>-->
                        </ul>
                        <ul class="topbar_nav">
                            <li><a href="<?= site_url() ?>">Home</a></li>
                            <li><a href="<?= site_url("page/about") ?>">About Us</a></li>
                            <li><a href="<?= site_url("index/partner") ?>">Partners</a></li>
                            <li><a href="<?= site_url("index/api") ?>">API</a></li>
        ...
        <section class="container clearfix main-container">
           	<div id="container" class="text-center">
				...
				<?php echo "It Happens , We all have bad days :( try again later" ?>
			</div>
