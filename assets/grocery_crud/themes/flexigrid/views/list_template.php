...
<div id='list-report-error' class='report-div error alert alert-dismissable alert-danger'></div>
<div id='list-report-success' class=' alert alert-dismissable alert-success report-div success report-list' <?php if($success_message !== null){?>style="display:block"<?php }?>><?php
