...
class Hybrid_Providers_Facebook extends Hybrid_Provider_Model
{
	...
	public $scope = "email, user_about_me, user_birthday, user_hometown, user_website, read_stream, read_friendlists";
	...
	function getUserActivity( $stream )
	{
		...
		foreach( $response['data'] as $item ){
			...
			if( ! empty( $ua->text ) ){
				...
				$ua->user->photoURL     = "https://graph.facebook.com/" . $ua->user->identifier . "/picture?type=large";
