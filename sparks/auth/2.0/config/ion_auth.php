 ...
 */
$config['site_title']           = "locname.com"; 		// Site Title, example.com
$config['admin_email']          = "info@locname.com"; 	// Admin Email, admin@example.com
...
$config['forgot_password_expiration'] = 2000; 				// The number of seconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
...
$config['error_start_delimiter']   = '<p class="error">';		// Error mesage start delimiter
