            ...
            if ( $this->ion_auth_model->forgotten_password($identity) )   //changed
            {
                ...
                if ($user)
                {
                    ...
                    else
                    {
                        ...
                        $mailData = array("username" => $user->username);
                        $otherData = array("URL" => site_url("auth/reset_password/" . $user->forgotten_password_code));
                        $sent = send_email("forgot_password", $user, $mailData, $otherData);
